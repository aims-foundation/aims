...
% bbm package doesn't work with XeTeX/unicode-math, define \mathbbm using doublestroke
% \usepackage{bbm}  % Commented out - incompatible with XeTeX
% Use \mathbb from unicode-math as fallback for \mathbbm
